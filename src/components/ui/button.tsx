  ...
  'flex justify-center items-center shrink-0 disabled:pointer-events-none disabled:opacity-50 cursor-pointer outline-none disabled:text-neutral-800',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-neutral-300 text-sm font-bold px-3 py-1 text-neutral-900 rounded-full bg-background hover:shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
      },
      size: {
        default: 'h-11',
        outline: 'h-7',
